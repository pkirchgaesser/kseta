set(CPACK_PACKAGE_DESCRIPTION "kseta Project")
set(CPACK_PACKAGE_DESCRIPTION_SUMMARY "kseta Project")
set(CPACK_PACKAGE_VENDOR "HEP Software Foundation")
set(CPACK_PACKAGE_VERSION ${kseta_VERSION})
set(CPACK_PACKAGE_VERSION_MAJOR ${kseta_MAJOR_VERSION})
set(CPACK_PACKAGE_VERSION_MINOR ${kseta_MINOR_VERSION})
set(CPACK_PACKAGE_VERSION_PATCH ${kseta_PATCH_VERSION})
...
function(hsf_get_platform _output_var)
  ...
  elseif(CMAKE_SYSTEM_NAME MATCHES "Linux")
    ...
    if(EXISTS "/etc/os-release")
      ...
      find_program(kseta_LSB_RELEASE_EXECUTABLE lsb_release
        DOC "Path to lsb_release program"
        )
      mark_as_advanced(kseta_LSB_RELEASE_EXECUTABLE)
      if(kseta_LSB_RELEASE_EXECUTABLE)
        # - ID
        execute_process(COMMAND ${kseta_LSB_RELEASE_EXECUTABLE} -is
          OUTPUT_VARIABLE HSF_OS_ID
          OUTPUT_STRIP_TRAILING_WHITESPACE
          )
        string(TOLOWER ${HSF_OS_ID} HSF_OS_ID)
        # - Version
        execute_process(COMMAND ${kseta_LSB_RELEASE_EXECUTABLE} -ir
          OUTPUT_VARIABLE HSF_OS_VERSION
          OUTPUT_STRIP_TRAILING_WHITESPACE
          )
        string(REGEX REPLACE "([a-z0-9]+)(\.|-|_)([a-z0-9]+).*" "\\1\\3" HSF_OS_VERSION ${HSF_OS_VERSION})
...
set(CPACK_PACKAGE_INSTALL_DIRECTORY "kseta_${kseta_VERSION}")
set(CPACK_PACKAGE_FILE_NAME "kseta_${kseta_VERSION}_${HSF_PLATFORM}")
